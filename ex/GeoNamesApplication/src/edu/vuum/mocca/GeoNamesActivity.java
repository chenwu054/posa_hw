...
public class GeoNamesActivity extends GeoNamesBase {
    ...
    ServiceConnection mServiceConnectionAsync = new ServiceConnection() {
     ...
     //*******the callBack is in the activity process and main thread?*******
     //!!!!!!!!why is GeoNamesServiceAsync asynchronous? just because the activity provides a callBack method?
     // synchronous means sequential? sequential between activity and service? have to finish service before proceeding 
     // with the activity?

...
public class DownloadActivity extends DownloadBase {
    ...
    static class MessengerHandler extends Handler {
    	...
    	public void handleMessage(Message msg) {
    		...
    		if (activity != null) {
    			...
    			String outputPath = data.getString("PATHNAME");
    ...
    public void runService(View view) {
        ...
        case R.id.intent_service_button:
        	...
        	//DownloadUtils.makeMessengerIntent(context, service, handler, uri)
        	uri = getUrlString();
        	final Intent intent = DownloadIntentService.makeIntent(this, handler, uri);
        ...
        case R.id.thread_pool_button:
            ...
            // returned from the makeIntent() factory method.
        	uri = getUrlString();
        	final Intent threadPoolIntent = ThreadPoolDownloadService.makeIntent(this, handler, uri);
